...
| `src/Pagebound.Core/Domain/ConversionTypes.cs` | `ConversionFormat` (Png, Jpg, Text, Html, Csv) + `ConversionResult(Bytes, FileExtension, MimeType)` |
