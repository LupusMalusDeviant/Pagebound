...
/// §19 UStG), Geschäftsbrief nach DIN 5008, Flyer und 16:9-Folie. Reine Daten —
/// keine UI-Abhängigkeit, damit gut testbar und wiederverwendbar.
/// </summary>
public static class EditorTemplates
{
    ...
    private static EditorDocument Doc(string title, PageLayout layout, params EditorBlock[] blocks) =>
        new() { Title = title, Layout = layout, Blocks = blocks.ToList() };
    ...
    private static EditorDocument Slide() => Doc(
        ...
        H("Titel der Folie", 1, "center"),
        Rect("#2563eb", 4),
        P("Kernaussage oder Untertitel der Präsentationsfolie", "center"));
}
