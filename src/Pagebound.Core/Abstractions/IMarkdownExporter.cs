...
/// <summary>
/// Exportiert Annotationen (Highlights, Sticky Notes, Freitexte) einer PDF in
/// eine Markdown-Datei mit YAML-Frontmatter — Obsidian-/Zettelkasten-kompatibel.
